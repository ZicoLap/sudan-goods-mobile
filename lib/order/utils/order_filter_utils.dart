...
String orderAmountLabel(AppLocalizations l10n, AmountRangePreset preset) {
  switch (preset) {
    case AmountRangePreset.any:
...
String orderDateLabel(AppLocalizations l10n, DateRangePreset preset) {
  switch (preset) {
...
String orderSortLabel(AppLocalizations l10n, OrderSortOption sort) {
  switch (sort) {
    case OrderSortOption.newestFirst:
